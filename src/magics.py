...
# TODO this is copied from ssifventure.base
import venture.shortcuts as vs
...
class VentureMagics(Magics):
    ...
    def __init__(self, shell):
        ...
        print "LOADING SSIFVENTURE STUFF!"
        print "UPDATE!"
        #self._ripl.load_plugin('/scratch/marcoct/iventure_test/ssifventure/src/backend/plugin.py') # TODO hardcoded path
        self._ripl.load_plugin('/scratch/marcoct/iventure_test/basic_plugin.py') # TODO
        self._ripl.execute_program_from_file('/scratch/marcoct/iventure_test/ssifventure/src/backend/inference.vnts') # TODO hardcoded path
    ...
    @logged_cell
    @line_cell_magic
    def venturescript_eval(self, line, cell=None):
        script = line if cell is None else cell
        # XXX Whattakludge!
        self._venturescript.append(script)
        return convert_from_stack_dict(self._ripl.evaluate(script, type=True))
